...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2020-04-24T05:25:12.149Z[GMT]")
...
public interface VariationsApi {
	...
	@ApiOperation(value = "Create a Dough", nickname = "createDough", notes = "Creates a new instance of a `Dough`.", response = Dough.class, authorizations = {
			@Authorization(value = "Authentication") }, tags = { "variations", })
